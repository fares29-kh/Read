...
<html lang="en">
    ...
    <ul>
        ...
        <li class="active"><a href="suppression_etudiant.php">Suppression</a></li>
        ...
        <section>
            ...
            <?php
                if(isset($_GET['erreur'])){
                    $err = $_GET['erreur'];
                    if($err==1){
                        echo "<p style='color:red'>etudiant supprimer</p>";
                    } elseif ($err==2) {
                        echo "<p style='color:red'>Error:</p>";
                    }
                }
                ?>
            <form action="supp_etud.php" method="POST">
                <label><b>nom</b></label>
                <br><input type="text" placeholder="Entrer le nom de etudiant" name="nom" required>
                <br><br><br><input type="submit" value="Supprimer">
